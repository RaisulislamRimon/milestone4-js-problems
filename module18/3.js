...
// এখন তোমার কাজ হচ্ছে একটা while লুপ রিভার্স ওয়েতে (decremental হিসেবে)করে ১০ বার চালিয়ে উপরের জিনিসগুলা আউটপুট হিসেবে দেখানো।

let i = 10;
while (i >= 1) {
  console.log(`${i} : প্রাকটিস চ্যালেঞ্জ-১
